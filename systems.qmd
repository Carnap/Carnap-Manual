...
For the corresponding proof systems, [see here](logic-book.html).
...
For the corresponding proof systems, [see here](forallx-pitt.html).
...
For the corresponding proof systems, [see here](forallx-msu.html).
...
For the corresponding proof systems, [see here](montague.html).
...
calculus](sequent-calculus.html) and [natural deduction](gentzen-ND.html).
...
For the corresponding proof systems, [see here](forallx-yyc.html).
