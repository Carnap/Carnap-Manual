...
Click the [login link](https://carnap.io/auth/login) located in the upper right hand
...
8. [Truth Trees (Semantic Tableaux)](truth-tree.html)
9. [Syntax Checking](syntax-check.html)
