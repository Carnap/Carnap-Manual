...
- The original version of *forall x* by P.D. Magnus, described on this
  page.
- [*forall x: Calgary*](forallx-yyc.html)
- [*forall x: Mississippi State*](forallx-msu.html)
- [*forall x: Pittsbugh*](forallx-pitt.html)
- *forall x: UBC*
...
Markup](pandoc.html)) has the following set of rules for direct
inferences:
...
Markup](pandoc.html)) also adds the
following rules:
